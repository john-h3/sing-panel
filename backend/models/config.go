...
type AppConfig struct {
	...
	CustomizedFeaturesEnabled bool              `json:"customizedFeaturesEnabled"` // Enable features provided by the customized sing-box fork
}
...
type ConfigUpdateRequest struct {
	...
	CustomizedFeaturesEnabled *bool              `json:"customizedFeaturesEnabled"`
}
